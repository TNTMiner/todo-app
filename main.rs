...
pub fn main() {
    ...
    let todo_model = Rc::new(slint::VecModel::<TodoItem>::from(vec![
        TodoItem { checked: false, title: "Get Calender integration for how many days an items been pending".into() },
        TodoItem { checked: false, title: "Get an icon, and a application title".into()},
        TodoItem { checked: false, title: "Release it".into()},
        TodoItem { checked: false, title: "Add text wrap".into()}
    ]));
